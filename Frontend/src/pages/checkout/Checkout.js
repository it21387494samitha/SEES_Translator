...
<div className="flex flex-col justify-center items-center mr-28"> 
  <h2 className="text-3xl font-bold leading-9 tracking-tight text-gray-900">Check Out</h2>
...
<div className=" bg-white  ml-16  " style={{width:"130vh",border:"1px solid black", boxShadow: "0 0 10px rgba(0, 0, 0, 0.5)",borderRadius: "10px"}}>

    <div className="flex">
        
    <div className="relative col-span-full flex flex-col py-6 pl-8 pr-4 sm:py-12 lg:col-span-4 lg:py-24" style={{ width: "60vh", background: "#FF7F0E", borderRadius: "10px", boxShadow: "0px 4px 10px rgba(0, 0, 0, 0.1)" }}>
...
<div className="flex flex-col mb-6" style={{ width: "70vh",background: "white" }}>
<form
  action=""
  onSubmit={(e) => {
    handleSubmit(e);
    ...
    <div className="mr-6 flex flex-wrap">
      <div className="my-1">
        ...
        <select
          ...
          style={{ color: 'gray', backgroundColor: 'white', borderColor: '#D1D5DB' }}
        >
...
<div className="flex flex-col pt-72 ">
          <img src={paymentphoto1} className=" pb-0" style={{ width: "100vh", height: "53vh " }} />
        </div>
        </div>
  );
}
