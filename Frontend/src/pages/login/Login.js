  ...
  return (
    <div style={{ height: "100vh" }}>
      <div className="flex w-full h-30 bg-white ">
        <div className="flex w-26 h-24 ">
          <img src={logol} alt="" />
        </div>
        <div className=" py-3  mr-70  pt-20 text-5xl font-bold leading-9 tracking-tight text-gray-900">
        ...
        >
          ...
          <div className="w-1/2 bg-white">
            {!user ? (
              <div className=" px-16">
                <div
                  className="min-h-92 flex flex-col justify-center items-center py-12 lg:px-8 bg-white mt-7"
                  style={{
                    height: "70vh",
                    width: "60vh",
