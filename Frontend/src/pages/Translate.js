...
export default function Translate() {
  ...
  const isMembershilActive = async () => {
    try {
      ...
      await axios
        .get(`${url}/membership/getMembershipDetails`, { data })
        .then((res) => {
  ...
  const translate = async () => {
    ...
    try {
      const response = await axios.get(`${url}/translate/translation`, {
        params: data,
      });
  ...
  const storeTranslationData = async (data) => {
    try {
      ...
      await axios.post(`${url}/history/save`, resp);
