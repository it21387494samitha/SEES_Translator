...
export default function ControlPanel() {
  ...
  const handleDelete = (id) => {
    axios
      .delete(`${url}/membershipType/delete/` + id)
      .then((res) => {
        console.log(res);
  ...
  const handleUpdate = (id) => {
    window.location.href = `${url}/update-member/` + id;
  };
...
<div className="flex h-screen">
  <div className="px-4 py-2  bg-blue-950 text-white lg:w-1/4">
    <svg
    ...
    <div className="hidden lg:block">
      <div className="my-2 mb-6">
        <h1 className="w-full px-4 py-2 text-orange-600 text-2xl lg:w-full">Admin Dashboard</h1>
      </div>
      ...
      <ul>
        <li className="mb-6">
          <div className="relative">
            ...
            <input
              type="search"
              name="search"
              className="w-full px-4 py-2 pl-12 rounded shadow outline-none bg-white text-white"
              placeholder="Search..."
              value={searchQuery}
        ...
        <li className="mb-2 rounded  bg-orange-600 hover:shadow hover:bg-blue-700">
                    ...
                    <tbody className="bg-white">
                      {filteredMembership.map((plan, index) => (
                        <tr key={index} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 w-10  text-gray-900 overflow-x-hidden whitespace-nowrap">
                            {plan.description}
                          </td>
